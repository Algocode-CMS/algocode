...
urlpatterns = [
    ...
    path('standings/<int:standings_id>/', cache_page(0)(StandingsView.as_view()), name='standings'),
    path('standings/<int:standings_id>/<int:contest_id>/', cache_page(0)(StandingsView.as_view()), name='standings'),
    path('standings_data/<int:standings_id>/', cache_page(0)(StandingsDataView.as_view()), name='standings_data'),
