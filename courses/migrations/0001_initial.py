    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.TextField()),
                ('file', models.TextField(blank=True, verbose_name=courses.models.get_main_file_path)),
                ('link', models.TextField(blank=True)),
                ('hidden', models.BooleanField(default=False)),
                ('new_tab', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contests', models.ManyToManyField(to='courses.Contest')),
                ('groups', models.ManyToManyField(to='courses.ParticipantsGroup')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='groups',
            field=models.ManyToManyField(related_name='participants', to='courses.ParticipantsGroup'),
        ),
        migrations.AddField(
            model_name='course',
            name='teachers',
